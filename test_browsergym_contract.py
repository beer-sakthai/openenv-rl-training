...
# Remove the datasets mock if it was added globally by another test module
for mod in list(sys.modules.keys()):
    if isinstance(sys.modules[mod], mock.Mock):
        del sys.modules[mod]
...
from train import BROWSERGYM_SPACE_URL, _browsergym_dataset, _browsergym_reward
